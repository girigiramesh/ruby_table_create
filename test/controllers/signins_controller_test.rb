...
class SigninsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signin" do
    assert_difference('Signin.count') do
      post signins_url, params: { signin: { password: @signin.password, userame: @signin.userame } }
    end
  ...
  test "should update signin" do
    patch signin_url(@signin), params: { signin: { password: @signin.password, userame: @signin.userame } }
